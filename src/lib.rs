    ...
    pub async fn new(window: Arc<Window>) -> anyhow::Result<Self> {
        ...
        let render_pipeline = device.create_render_pipeline(&wgpu::RenderPipelineDescriptor {
            ...
            vertex: wgpu::VertexState {
                ...
                buffers: &[Vertex::desc()],   // vertex buffer layouts (analogous to VAOs in OpenGL)
            ...
            cache: None, // not caching shader compilation data (people say it's not that useful except on Android)
        });
